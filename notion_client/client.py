...
class Client(BaseClient):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if client is None:
            client = httpx.Client(proxies=proxies) # Add Proxies By YunLambert
        super().__init__(client, options, **kwargs)

    def __enter__(self) -> "Client":
        self.client = httpx.Client(proxies=proxies) # Add Proxies By YunLambert
